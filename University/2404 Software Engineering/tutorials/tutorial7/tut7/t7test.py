...
def unzip_and_test(dirname, zipfile, outof):
	...
	print("\nLabel test\n")
	score += run(["./test"], 5, '0', ["A1", "A2", "A3"])
	
	print("\nAdd product test\n")
	score += run(["./test"], 5, '1 beans 10', ["beans", "10"])
	print("\nRemove product test\n")
	score += run(["./test"], 5, '2 beans 10 7', ["beans", "3"])
	print("\nPolymorphism test\n")
	score += run(["./test"], 5, '3 beans 10', ["beans", "10"])
...
def process_all():
	...
	dirname = 'tutorial7'
	unzip_and_test(dirname,zipfile, 18)
