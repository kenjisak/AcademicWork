...
const string subs[3] ={"Sub1", "Sub2", "Sub3"};
const string creds[3] ={"0000", "1111", "2222"};
const string hosts[3] ={"Irene", "Bob", "Alice"};

//const string content[20];  - at end of file
