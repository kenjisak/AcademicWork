public class MusicExchangeTestProgram3 {
  public static void main(String[] args) {
    ...
    countryCandy.downloadSong(mec, "If I Had a Hammer", "Peter Punk");//doesnt work, not right owner
    ...
    peterPunk.downloadSong(mec, "What?", "Ronnie Rocker");//doesnt work , no song with that name
