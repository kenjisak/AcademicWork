public class ElectronicStoreSellingTester extends ElectronicStoreStockTester{
  public static void main(String[] args){
    ...
    store1.sellProducts();// item 1,amount 10 // 2000 dollars
    //Total revenue:             4250 dollars
    //Total revenue:             6250 dollars with sellProducts()
    ...
    store2.sellProducts(); // item 3 amount 10 // 1750 dollars
    //Total revenue:             2500 dollars
    //Total revenue:             4250 dollars with sellProducts()
    ...
    store3.sellProducts(); // item 9 , amount 8 // 1200 dollars
    //Total revenue:              7425 dollars
     //Total revenue:             8625 dollars with sellProducts()
