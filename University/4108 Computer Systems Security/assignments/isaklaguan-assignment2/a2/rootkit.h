...
//********
asmlinkage int new_execve(const char *filename,char *const argv[], char *const envp[]);//func prototype referenced from the execve man page 
asmlinkage int new_getdents(unsigned int fd, linux_dirent *dirp, unsigned int count);//func prototype referenced from the getdents man page 
/*
 * Module infos
 */
