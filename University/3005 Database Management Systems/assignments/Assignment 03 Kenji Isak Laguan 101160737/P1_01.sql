/*
Q1) Produce a table consisting of the names and addresses of the subscribers and their phone numbers.
name
address
phone no 
of subs

name address from subs table
join using port id 
line table to get
phone no
*/

select name, address, areacode ||'-'|| officecode ||'-'|| stationcode as number
from
   subscribers
